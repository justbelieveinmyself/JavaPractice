...
public class BoardUtils {
    /**
     * Assumption - the slots lie on the same diagonal
     */
    ...
    /**
     * Assumption - the slots lie on the same horizontal
     */
    ...
    public static void main(String[] args) {
        List<Coordinates> coordinatesD = getDiagonalCoordinatesBetween(new Coordinates(File.E, 3), new Coordinates(File.H, 6));
        System.out.println(coordinatesD);
